...
//for example, I created checks and token folders file from here manually.. they are just to show ,how these files(checks & token folders file) looked if we created them from client side input
lib.create(
  "users",
  "01710201020",
  {
    firstName: "william",
    lastName: "Henry",
    phoneNumber: "01710201020",
    tos: true,
    password:
      "984814a4e3afc3b8d4b1c2446f94265c1d423a1f3214381bf04c8bf60bbc273c",
  },
  (manualErr, runError) => {
